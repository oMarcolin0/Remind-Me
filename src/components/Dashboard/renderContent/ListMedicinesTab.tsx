...
interface ListMedicinesTabProps {
  medicines: Medicine[];
  handleRemoveMedicine: (id: string) => void;
  handleEditMedicine: (id: string) => void;
              ...
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <div className="flex gap-2 mt-2 flex-wrap">
                    {medicine.time?.split(',').map((t, index) => (
                ...
                <div className="flex items-center gap-3 flex-shrink-0">
                  <span className={`px-3 py-1 rounded-full text-sm font-medium ${
                    medicine.completed ? 'bg-green-100 text-green-800' : 'bg-yellow-100 text-yellow-800'
                  }`}>
